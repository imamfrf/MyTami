...
class FlightConfirmationAdapter(private val items: ArrayList<FlightOutbound>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FlightConfirmationAdapter.ViewHolder {
        val itemView = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_flight_detail, parent, false)
        return FlightConfirmationAdapter.ViewHolder(itemView)
    }
